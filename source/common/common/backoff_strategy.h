...
public:
  ...
  bool isOverTimeLimit(uint64_t interval) override { return interval > max_interval_; }
...
public:
  ...
  bool isOverTimeLimit(uint64_t interval) override { return interval > min_interval_; }
...
public:
  ...
  bool isOverTimeLimit(uint64_t interval) override { return interval > interval_ms_; }
